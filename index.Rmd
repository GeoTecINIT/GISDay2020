...
???
Remote Sensing es cotidiano, no va solo de satélites...
...
.right-column[
  ...
  - Imagen multiespestral `r fontawesome::fa(name = "arrow-circle-right")` pocas bandas (N `r fontawesome::fa(name="arrow-down")`)  
  - Imagen hiperespectral `r fontawesome::fa(name = "arrow-circle-right")` muchas bandas (N `r fontawesome::fa(name = "arrow-up")`)  
...
# .large[¿Buscas materiales para saber más?]
