...
### .center[`r emo::ji("computer")` + .fancy[`p`]]
]
...
.right-column[
  <iframe width="800" height="600" src="http://www.gisday.com/en-us/overview" frameborder="0" allowfullscreen></iframe>
]
...
Proceso de captura de datos, recogida de  informacion precisa para la toma de decisiones en vuestro trabajo. y 
luego evaluar que las decisiones/resultoados son los correctos

Ahi, las tecnologias espaciales, los sistemas de información geográfica, y remote sensing os pueden ayudar
