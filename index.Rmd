...
---
class: center
# .acidinline[Active vs Pasive] Remote Sensing
...
### .center[.whiteinline[Las imágenes de satélites no son solo fotos]] 


???
Fuente: [La imagen de la Tierra saliendo sobre la luna en 1968 que lo cambió todo](https://www.nationalgeographic.es/espacio/2018/12/la-imagen-de-la-tierra-saliendo-sobre-la-luna-en-1968-que-lo-cambio-todo)
...
.right-column[
  ### Espectro electromagnético .acidinline[para RS]
...
.right-column[
  ### vegetación .acidinline[sana] `r fontawesome::fa(name = "not-equal")` vegetación .heatinline[enferma]
...
.right-column[
  ### **NDVI** .small[Normalized Difference Vegetation Index]
...
.right-column[
  ### **NDVI** toma valores desde .heatinline[-1] a .acidinline[+1]
...
Generalmemte, valores de NDVI entre 0.2 y 0.4 corresponden a áreas con vegetación escasa; la vegetación moderada tiende a variar entre 0.4 y 0.6; cualquier cosa por encima de 0.6 indica la mayor densidad posible de hojas verdes.
